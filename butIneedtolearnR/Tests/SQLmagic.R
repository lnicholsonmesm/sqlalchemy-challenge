...
r <- plumb('/Users/lauranicholson/Desktop/data_analysis/bootcamp/Homework/sqlalchemy-challenge/butineedtolearnR/plumber.R')  # Where 'plumber.R' is the location of the file shown above
r$run()
